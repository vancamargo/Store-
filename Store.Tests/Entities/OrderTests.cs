...
namespace Store.Tests
{
    ...
    public class ProductQueriesTests
    {
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_novo_item_com_quantidade_zero_ou_menor_o_mesmo_deve_ser_adicionado()
        {
            var order = new Order(_customer, 0, null);
        ...
        public void Dado_um_desconto_expirado_o_valor_do_pedido_deve_ser_60()
        {
            ...
            var order = new Order(_customer, 10, expiredDiscount);//+10 - 0 =10
            order.AddItem(_product, 5); //10*5 =50
        ...
        {
            var order = new Order(_customer, 10, null);//+10 - 0 =10
            order.AddItem(_product, 5); //10*5 =50
            Assert.AreEqual(order.Total(), 60);
        }
        [TestMethod]
        ...
        {
            var order = new Order(null, 10, _discount);//total 0
